...
<html lang="en">
	...
	<body class="home">
		...
		<!-- Content Section -->
		<div id="casaroyal-page-half-map" class="casaroyal-page-map-right">
			...
			<div id="properties-grid-view">
				...
				<section class="advance-search">
		        	<div class="as-form-wrap">
					    <form class="row advance-search-form clearfix ajax_load"  method="get">
					        ...
					        <div class="af-estate-search-field col-md-4">
					            <span class="selectwrap">
					                <select name="bedrooms" id="select-bedrooms" class="search-select">
					                    <option value="any" selected="selected">Min Beds</option>
					        ...
					        <div class="af-estate-search-field col-md-4">
					            <span class="selectwrap">
					                <select name="bathrooms" id="select-bathrooms" class="search-select">
					                    <option value="any" selected="selected">Min Baths</option>
					                    <option value="1">1</option>
					                    <option value="2">2</option>
					                    <option value="3">3</option>
					                    <option value="4">4</option>
					        ...
					        <div class="af-estate-search-field col-md-4 price-for-others">
					            <div class="cardojo-price-range-holder">
					                <label>Price</label> <span class="min-price-text">$<span>900</span></span> - <span class="max-price-text">$<span>15,000</span></span>
					            </div>
					            <input type="hidden" id="priceMin" value="900">
					            <input type="hidden" id="priceMax" value="15000">
					            <div id="priceRange"></div>
					        </div>
					        <div class="af-estate-search-field col-md-4">
					            <input type="text" name="min-area" id="min-area" pattern="[0-9]+" value="" placeholder="Min Area" title="Please only provide digits!">
					        </div>
					        <div class="af-estate-search-field col-md-4">
					            <input type="text" name="max-area" id="max-area" pattern="[0-9]+" value="" placeholder="Max Area" title="Please only provide digits!">
					        </div>
					        <div class="af-estate-search-field col-md-4 af-estate-search-btn-holder">
					            <input type="submit" value="Search" class="af-estate-search-btn">
					        </div>
					        <div class="clearfix"></div>
					        <div class="col-md-12 amenities-trigger">
			                    <a href="#">
			                ...
			                <div class="amenities-wrapper clearfix collapsed">
			                    <div class="af-estate-search-field col-md-3">
				...
				<!-- Properties Grid -->
				<div class="properties-map-holder">

					<div class="row">

						<!-- Property -->
						<div class="col-md-6 property-grid-item property-item-data clearfix" 
							data-lat="33.6262516" 
