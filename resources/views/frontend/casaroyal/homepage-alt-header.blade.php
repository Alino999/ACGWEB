	...
	<body class="home">
		...
		<div class="casaroyal-property-asf-wrapper">
			...
			<div class="container">
				...
				<div class="casaroyal-property-asf mb-150">
		
	    			<h2 class="title search-heading">Let Us Guide You Home</h2>
	    			<p class="search-heading-subtitle">Find the house of your dreams</p>
		...
		<div class="casaroyal-featured-properties-section">
			<div class="container">
			    <div class="casaroyal-inline-block">
					<div class='owl-demo owl-carousel owl-theme owl-properties property-grid-view'>
		...
		<!-- Contact Us Section -->
		<div class="casaroyal-section casaroyal-background-white">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="casaroyal-entry-title-wrapper">
							<h2 class="align-center"><strong>Have Questions?</strong></h2>
							<h4 class="align-center">Call us for a Free Consultation at <a href="callto:#">(123) 456-7890</a></h4>
					    </div>
					</div>
				</div>
			</div>
